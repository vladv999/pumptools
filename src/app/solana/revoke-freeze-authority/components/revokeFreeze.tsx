...
export default function RevokeFreeze() {
    ...
    async function handleClick(){
        ...
        const tokenAddress = document.getElementById("revokeFreezeTokenAddress") as HTMLInputElement;
        ...
        try {
            ...
            toast.success('Success revoke freeze authority', {
                position: "top-center",
                autoClose: 5000,
                draggable: true,
                progress: undefined,
    ...
    return (
        <>
            ...
            <button className="btn btn-primary" onClick={handleClick}>Revoke Freeze Authority</button>
